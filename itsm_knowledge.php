...
$url = @$functions->getSettingValue(17) . "/itsm_knowledge.php?id=$ITSMTypeID";
...
<script>
	...
	$(document).ready(function() {
		getITSMDatarowsKnowledge(<?php echo $ITSMTypeID ?>, '<?php echo $UserLanguageCode ?>', 'all');
	});
</script>
			...
			<div class="card">
				<div class="card-header">
					...
					if (in_array("100001", $group_array) || in_array("100015", $group_array)) {
						//echo $navMenu04 = navMenu04($ITSMTypeID);
					} ?>
					<div class="float-end">
						<ul class="navbar-nav justify-content-end">
							<li class="nav-item dropdown pe-2">
						...
						<div class="scrolling-menu-wrapper">
							...
							<div class="scrolling-menu">
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									<li class="nav-item">
										<a class="nav-link active" data-bs-toggle="tab" data-bs-target="#All" href="#All" onclick="getITSMDatarowsKnowledge(<?php echo $ITSMTypeID ?>, '<?php echo $UserLanguageCode ?>','all');">
											<?php echo _("All"); ?>
										</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" data-bs-toggle="tab" data-bs-target="#My" href="#My" onclick="getITSMDatarowsKnowledge(<?php echo $ITSMTypeID ?>, '<?php echo $UserLanguageCode ?>','my');">
											<?php echo _("Mine"); ?>
										</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" data-bs-toggle="tab" data-bs-target="#MyTeams" href="#MyTeams" onclick="getITSMDatarowsKnowledge(<?php echo $ITSMTypeID ?>, '<?php echo $UserLanguageCode ?>','myteams');">
											<?php echo _("My teams"); ?>
										</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" data-bs-toggle="tab" data-bs-target="#MeParticipating" href="#MeParticipating" onclick="getITSMDatarowsKnowledge(<?php echo $ITSMTypeID ?>, '<?php echo $UserLanguageCode ?>','meparticipating');">
					...
					<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="tab-content" id="ITSMTabContent">
							<div class="tab-pane fade show active" id="All" role="tabpanel" aria-labelledby="All">
								<table id="itsmtableall" class="table table-borderless table-responsive table-hover" cellspacing="0">
								</table>
							</div>
							<div class="tab-pane fade" id="My" role="tabpanel" aria-labelledby="My">
