		...
		<div class="card-group">
			<div class="card">
				...
				<div class="card-body">
					<div class="row">
						<?php
							$sql = "SELECT cmdb_ci_fieldslist.FieldName, cmdb_ci_fieldslist.Label, cmdb_fieldslist_types.Definition, cmdb_ci_fieldslist.FieldDefaultValue, cmdb_ci_fieldslist.fieldtitle, cmdb_ci_fieldslist.SelectFieldOptions, cmdb_ci_fieldslist.FieldWidth,
					...
					<button type="button" class="btn btn-sm btn-success float-end" onclick="createRequest()"><?php echo _("Create") ?></button>
				</div>
			</div>
		</div>
	</div>
