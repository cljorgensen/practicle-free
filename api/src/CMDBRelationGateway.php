...
class CMDBRelationGateway
{
    ...
    public function getAll(string $id, string $entity): array
    {
        ...
        $sql = "SELECT *
                ...
                WHERE CITable1 = '$MainTableName' OR CITable2 = '$MainTableName'";
    ...
    {
        global $conn;
        $logentry = mysqli_real_escape_string($conn, $logentry);

        $sql = "INSERT INTO debuglog(LogEntry) VALUES ('$logentry')";
